  ...
  return (
    <>
        ...
        <div className="flex flex-col items-center justify-center py-10 bg-gray-100 dark:bg-zinc-900">
            <h2 className="text-3xl text-center font-bold mb-6">Pourquoi choisir <span className="bg-gradient-to-r from-red-500 via-purple-500 to-pink-500 bg-clip-text text-transparent md:font-bold">
            Bikershop
          </span></h2>
