...
const ChooseUs = () => {
  return (
    <>
        <PageWrapper>
        <div className="flex flex-col items-center justify-center  py-24 bg-gray-100 bg-[url('/images/motoBgServices.png')] bg-no-repeat  bg-[-15%_90%] dark:bg-zinc-900">
            <h2 className=" text-3xl md:text-5xl text-center font-semibold mb-6">Pourquoi choisir <span className="bg-gradient-to-r from-red-500 via-purple-500 to-pink-500 bg-clip-text text-transparent md:font-bold">
            Bikershop
          </span></h2>
          <div className="w-1/6 h-2 bg-red-500 md:w-[10%] md:h-1"></div>
